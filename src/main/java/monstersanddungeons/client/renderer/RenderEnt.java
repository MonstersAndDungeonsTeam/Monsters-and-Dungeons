...
public class RenderEnt extends RenderLiving<EntityLiving>{

	ResourceLocation location = new ResourceLocation(Reference.MODID + ":textures/models/Ent.png");
	protected ModelBase modelEntity;
	
	public RenderEnt(ModelBase base) {
