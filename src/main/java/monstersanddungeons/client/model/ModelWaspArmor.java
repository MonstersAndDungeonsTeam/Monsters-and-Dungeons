package ruukas.monstersanddungeons.client.model;
...
public class ModelWaspArmor extends ModelBiped {
    ...
    public ModelWaspArmor(EntityEquipmentSlot slot) {
        ...
        this.bipedRightArm.addChild(this.Arm01);
        this.bipedLeftArm.addChild(this.Arm02);
        
        this.bipedBody.addChild(this.Body);
        
        this.bipedRightLeg.addChild(this.Leg01);
        this.bipedLeftLeg.addChild(this.Leg02);
